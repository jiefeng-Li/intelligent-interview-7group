...
$(document).ready(function(){
	//下拉层效果,点击二级，显示三级类别
	$("#ChooseJobClassLayer .z_prof_n .detail li").on("click", function () {
		var checkedStr = "";
		var $this = $(this);
		var arrhtml = [];
	...
	$("#ChooseJobClassLayer .job_lab").on("click", function () {
	...
	$("#ChooseJobClassLayer .job_lab").on("mouseenter", function () {
		$(this).addClass("job_lab_active");
	});
	$("#ChooseJobClassLayer .job_lab").on("mouseleave", function () {
		$(this).removeClass("job_lab_active");
	});
	$("#ChooseJobClassLayer .RemoveJobClass").on("click",function () {
		$("#ChooseJobClassLayer .ShowJobClass div").remove();
		$("#ChooseJobClassLayer :input").prop({ "checked": false, "disabled": false });
	});
	//确认按钮
	$("#ChooseJobClassLayer .queding").on("click", function () {
	...
	//下拉层大类点击
	$("#ChooseJobClassLayer .twojobclass label").on("click", function (e) {
		e.stopPropagation();
	});
	$("#ChooseJobClassLayer .twojobclass :input").on("change", function () {
	...
	//下拉小类点击
	$("#ChooseJobClassLayer .threejobclass label").on("click", function (e) {
		e.stopPropagation();
	});
	$("#ChooseJobClassLayer .threejobclass :input").on("change", function () {
		if ($(this).attr("checked")) {
			if(window.allow_select_jobclass_count==1){
				$("#ChooseJobClassLayer .ShowJobClass div").remove();
	...
	//根据搜索结果，点击选择
	$("#ChooseJobClassLayer .t_sort_n :input").on("change", function () {
	...
	//搜索
	$("#ChooseJobSearch").on("focus", function () {
...
$(document).ready(function(){
	//二级类点击
	$("#ChooseCityClassLayer .a_prof_n .detail li").on("click",function(){
		var checkedStr = "";
		var arrhtml = [];
		var $this = $(this);
	...
	//一级类点击
	$("#ChooseCityClassLayer .category :input").on("change",function(){
	...
	//下拉二级区域点击取消冒泡
	$("#ChooseCityClassLayer").find(" .flo_li label, .flo_li1 label").on("click", function (e) {
		e.stopPropagation();
	});
	$("#ChooseCityClassLayer").find(" .flo_li :input, .flo_li1 :input").on("change", function () {
		if(window.allow_select_cityclass_count==1){
			$("#ChooseCityClassLayer .ShowCityClass div").remove();
			$("#ChooseCityClassLayer :input[type=\"checkbox\"]").prop("checked", false);
	...
	//下拉小类点击
	$("#ChooseCityClassLayer .inp_n label").on("click", function (e) {
		e.stopPropagation();
	});
	$("#ChooseCityClassLayer .inp_n :input").on("change", function () {
		if(window.allow_select_cityclass_count==1){
			$("#ChooseCityClassLayer .ShowCityClass div").remove();
			$("#ChooseCityClassLayer :input[type=\"checkbox\"]").prop("checked", false);
	...
	$("#ChooseCityClassLayer .job_lab").on("click", function () {
		$(this).parent(".job").remove();
	...
	$("#ChooseCityClassLayer .job_lab").on("mouseenter", function () {
		$(this).addClass("job_lab_active");
	});
	$("#ChooseCityClassLayer .job_lab").on("mouseleave", function () {
		$(this).removeClass("job_lab_active");
	});
	$("#ChooseCityClassLayer .RemoveCityClass").on("click",function () {
		$("#ChooseCityClassLayer .ShowCityClass div").remove();
		$("#ChooseCityClassLayer :input").prop({ "checked": false, "disabled": false });
	});
	//搜索
	$("#ChooseCitySearch").on("focus", function () {
		if ($(this).val() == this.defaultValue) {
			$(this).val("");
		}
	}).on("blur",function () {
	...
	$("#ChooseCitySearch").on("keyup",function () {
		var $this = $(this);
		var txt = $this.val();
		if (txt.length == 0) {//没有关键字，显示全部
	...
	//根据搜索结果，点击选择
	$("#ChooseCityClassLayer .a_sort_n :input").on("change", function () {
		var ischeck = $(this).prop("checked");
		var bigvalue = $(this).val();
		var onechoosed = $("#ChooseCityClassLayer .ShowCityClass div[type=\"province\"]");
		var onechoosedArr = [];
