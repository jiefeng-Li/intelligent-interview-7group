...
import com.groupseven.serviceresume.mapper.Resume4InviteMapper;
...
public class ResumeServiceImpl implements ResumeService {
    ...
    @Autowired
    private Resume4InviteMapper resume4InviteMapper;
    @Autowired
    ...
    public List<ResumeDto> getResumeByJobSends(List<Integer> resumeIds) {
        ...
        return resume4InviteMapper.selectList(Wrappers.lambdaQuery(ResumeDto.class)
    ...
    public ResumeDto getResumeById(Integer resumeId) {
        return resume4InviteMapper.selectById(resumeId);
    }
}
